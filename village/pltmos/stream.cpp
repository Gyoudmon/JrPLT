...
/*************************************************************************************************/
#define WATERFALL_PATH digimon_appdata_path("scene/waterfall", "", "stone")
#define CLOUD_PATH digimon_appdata_path("scene/cloud", ".png", "stone")
#define SIGNS_PATH digimon_appdata_path("scene/signs", "", "stone")
#define FILTER_PATH digimon_appdata_path("scene/filter", "", "stone")
...
WarGrey::PLT::StreamPlane::StreamPlane(const char* spath) : TheBigBang("流"), stream_source(spath) {
    if (exists(path(spath))) {
        ...
        this->stream_source = digimon_appdata_path("stream", ".in", "tamer");
    }
