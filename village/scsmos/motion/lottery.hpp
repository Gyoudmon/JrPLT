...
namespace WarGrey::SCSM {
    enum class LMState { Play, Stop, Reset, _ };

    /** 声明游戏宇宙 **/
    class __lambda__ LotteryPlane : public WarGrey::SCSM::TheSCSMPlane {
    public:
        LotteryPlane(float gridsize = 8.0F) : TheSCSMPlane("摇奖机") {}
        virtual ~LotteryPlane() {}
    ...
    private:
        ...
        void switch_game_state(WarGrey::SCSM::LMState new_state);
    ...
    private:
        class Pinholet;
        WarGrey::SCSM::LotteryPlane::Pinholet* labview;

    private: // 游戏状态
        WarGrey::SCSM::LMState state = LMState::_;
    };
}
