...
语言的感官(Channel)指的是人与人交流时语言信息的传递方式。
...
前两点都不难理解，第三点是什么情况？
举个例子，英国人喜欢给外来单词加锐音符。
比如源自法语的café(咖啡馆类的轻食餐厅)
和源自日语的Pokémon(宝可梦)，
它们的e都戴了个小帽子，
用以表示“读这个单词时请还原它本源的发音”。
...
@tech{程序语言}不用考虑听觉，也不需要表达情绪，
但它们的语法检查要比@tech{自然语言}严格得多，
@margin-note*{你猜，
 哪一科的老师最喜欢强调标点符号的用法？
}尤其是对各种标点符号和附加符号的用法，
甚至死板到了不能出错的程度。
...
@focus{好的程序应该要方便人阅读，而又顺便也能在机器上运行}。
不知道你会怎么理解这个“顺便”，
