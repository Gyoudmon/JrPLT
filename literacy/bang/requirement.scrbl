...
@tamer-figure!['1stex "课堂实况照片"]{
 @(let ([s 0.725])
    (list @(para (stone-image "Bang/Live1.png" #:scale s) "二年级孩子认识 Shell")
          @(para (stone-image "Bang/Live2.png" #:scale s) "准四年级女孩思考绘制胡克定律实验图像")
          @(para (stone-image "Bang/Live3.png" #:scale s) "准七年级女孩体验“生命游戏”")))
}
