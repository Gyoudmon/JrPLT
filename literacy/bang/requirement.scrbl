...
@tamer-figure!['cm.exe "裁剪“混色模型”课程项目"]{
 @(let ([s 0.50])
    (list @(para (stone-image "Bang/ColorMixture1.png" #:scale s) "完整项目（标题、加色混合、减色混合）")
          @(para (stone-image "Bang/ColorMixture2.png" #:scale s) "裁剪项目（仅有加色混合）")))
}
