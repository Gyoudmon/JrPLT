...
@handbook-lesson{数学函数与程序函数}

@period-desc[
 #:goals big-bang-goals 
 #:datetime ["2023-12-23" "14:45" "16:15"]]

本主题继续上节课的代数思维，
主要任务是把@tech{数学函数}翻译成程序@tech{函数}。
小学生普遍没有“语法”概念，
因此这个翻译过程普遍也还是云里雾里。

这节课的例子函数还是课程早期的“胡克定律”，
当时学这个时学生还处在跟我接触的早期阶段，
纪律很差，不知道为啥要上这个课。
今天没有纪律问题了，
但我能感觉他们并没有真的理解@tech{函数}是什么。

这当然也是正常现象，
因此下节课开始下一个主题，
内容在数学的“数形结合”素养基础之上，
强调等式、函数关系、图像、图表、代码都只是同一个问题的不同表现形式。

@handbook-action{课后作业}

将圆的面积公式和圆锥的体积公式翻译成 Python 或 C++ 函数。
