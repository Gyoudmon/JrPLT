...
不过，回看@algo-ref{algo:rpcl}和@fig-ref{flow:rpcl}，
它们真的能帮你记忆关键线索吗？
...
是吧？Racket 代码读起来很像（语法怪异的）英语写的数学说明文，
但一眼看上去又不像数学证明。嗯，
...
@tamer-figure-margin['flow:mutation "经典“赋值运算”示意图"
...
@algo-ref[#:line (cons 4 5)]{
 algo:rpcl}和@algoref[#:line (cons 8 9)]{
 algo:rpcl}都在不断定义@focus{新}@tech{变量}，
这……看着就很灾难，太不优雅了。
