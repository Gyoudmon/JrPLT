...
static void null_snapshot(const char* state) {}
...
static void blind_watcher(const char* name, const char* type, const void* address, const char* segement) {}

__ffi__ watch_variable_t watch_variable = blind_watcher;
__ffi__ take_snapshot_t  take_snapshot = null_snapshot;

#else
#define take_snapshot null_snapshot
